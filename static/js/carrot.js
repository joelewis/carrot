(function($, carrot){
        ...
        var overlayDOM = '<div style="position:fixed; right:0px; bottom:0px; left:0px; top:0px;display:none;background:rgba(0,0,0,0.95);z-index:999;"><div style="position: absolute;top: 10px;right: 20px;color: #fff;cursor: pointer;">x</div><iframe src="http://'+host+'/iframe/notifications/'+carrot.app_secret+'/'+carrot.user_identifier+'/" style="width:100%;height:100%;border: 0px;outline: none;"></iframe></div>';
         ...
         var handleDOM = ''+
         '<div style="position: fixed;bottom: 20px;right: 20px;width: 300px;height: 60px;border: 1px solid #5893C5;border-radius: 7px;background: rgba(0, 0, 0, 0.6);padding: 10px;font-weight: bolder;color: #FFFFFF;text-align: center;">'+
