(function($, carrot){
        ...
        var overlayDOM = '<div style="position: fixed; right: 0px; bottom: 0px; left: 0px; top: 0px; display: none; background: rgba(0,0,0,0.5); z-index: 999;"><div class="glyphicon glyphicon-remove" style="position: absolute; top: 10px; right: 20px; color: #fff; cursor: pointer;"></div><iframe src="http://'+host+'/iframe/notifications/'+carrot.app_secret+'/'+carrot.user_identifier+'/" style="width:100%;height:100%;border: 0px;outline: none;"></iframe></div>';
